# All of the code credit to https://github.com/aalbayda/hear-hear-v2/blob/master/pybot.py
...
async def getmotion(interaction: discord.Interaction):
    req = requests.get("https://hellomotions.com/random-motion", headers={'User-Agent': 'Mozilla/5.0'})    
